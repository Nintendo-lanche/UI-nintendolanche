...
function SendMessage({ endOfMessagesRef }) {
  ...
  return (
    <form className="flex justify-center fixed bottom-5 bg-black opacity-95 w-4/12 px-4 py-2 max-w-2xl shadow-xl border-4 border-red-300/50 z-50 rounded-full">
      <input
      ...
      <button
        type="submit"
        onClick={sendMessage}
        className="font-bold text-red-300/80"
      >
        Send
      </button>
    </form>
